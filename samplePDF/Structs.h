...
/*
  ...
  // CC Other
  kMaCh3_CCMisc = 11, //ETA splitting CCOther and CCDIS for 2019 OA

  //DB Splitting NCOther into DIS, multi-pi for T2K+SK joint atmospheric fit
  // NC multi-pi
  kMaCh3_NCMpi = 12,
  // NC DIS
  kMaCh3_NCDIS = 13,
  ...
  //DB NewMaCh3Mode: Add enum value before kMaCh3_nModes
...
/*
  switch(i) {
    ...
    case kMaCh3_NCDIS:
      name = "NCDIS";
      break;
    //DB NewMaCh3Mode: Add case for short name of new MaCh3 mode
    default:
