...
void samplePDFFDBase::ApplyEventSelections(std::vector< std::string > SelectionStr, int iSample){
  for (unsigned int iSelection=0;iSelection<SelectionStr.size();iSelection++) {
	  const double* KineArr = GetPointerToKinematicParameter(SelectionStr[iSelection], iSample, 0);
...
// ***************************************************************************
// Calculate the spline weight for a whole sample
...
// ***************************************************************************
// Calculate the normalisation weight for a whole sample
